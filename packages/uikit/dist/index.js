...
__export(index_exports, {
  ...
  EMessageEngineMode: () => EMessageEngineMode,
  ...
  cn: () => cn,
  decodeStreamMessage: () => decodeStreamMessage,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          ...
          displayText && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "p",
            {
              className: cn(
  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      ...
      __spreadProps(__spreadValues({
        ...
        children: src && !imageError ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "img",
          {
            src,
            alt,
...
function Button(_a) {
  ...
  if (label) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col items-center", children: [
      button,
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: cn("text-muted-foreground mt-2 text-xs", labelClassName), children: label })
    ] });
  }
  return button;
}
...
function CommandInput(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_lucide_react.SearchIcon, { className: "size-4 shrink-0 opacity-50" }),
...
var Conversation = React4.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ConversationContext.Provider, { value: { scrollRef }, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      "div",
      __spreadProps(__spreadValues({
        ref,
        className: cn(
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { ref: scrollRef, className: "flex-1 overflow-y-auto", children: props.children }),
          showScrollButton && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ConversationScrollButton, { onClick: scrollToBottom })
        ]
      })
    ) });
  }
  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          icon && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "flex justify-center", children: icon }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-1", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h3", { className: "font-semibold", children: title }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-muted-foreground text-sm", children: description })
          ] })
        ]
      })
    );
...
function DropdownMenuCheckboxItem(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "pointer-events-none absolute left-2 flex size-3.5 items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(DropdownMenuPrimitive.ItemIndicator, { children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_lucide_react3.CheckIcon, { className: "size-2" }) }) }),
        children
      ]
    })
  );
...
function HelloWorld(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h1", { className: "mb-4 text-2xl font-bold", children: message }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: "text-muted-foreground", children: "Welcome to Agora AI Builder UI! This is your first component ." })
      ]
    })
  );
}
...
var LiveWaveform = (_a) => {
  ...
  const [data, setData] = (0, import_react.useState)(externalData || []);
...
var Message = React5.forwardRef(
  (_a, ref) => {
    ...
    const messageContent = /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex items-end gap-3", children: [
      from === "assistant" && avatar,
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "flex flex-col", children }),
      from === "user" && avatar
    ] });
...
var MicButton = React6.forwardRef(
  (_a, ref) => {
    var _b = _a, {
      state = "idle",
      icon = /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_lucide_react4.Mic, { className: "h-4 w-4" }),
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          isError ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_lucide_react4.MicOff, { className: "h-4 w-4" }) : icon,
          isActive && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            LiveWaveform,
            {
              active: isListening,
          ...
          isError && showErrorBadge && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "absolute -top-2 -right-2 flex h-5 w-5 items-center justify-center rounded-full bg-amber-400 text-amber-900", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "text-xs leading-none font-bold", children: "!" }) })
        ]
      })
    );
  }
...
function useAudioDevices() {
  ...
  const loadDevicesWithoutPermission = (0, import_react2.useCallback)(async () => {
    try {
      setLoading(true);
      setError(null);
  ...
  const loadDevicesWithPermission = (0, import_react2.useCallback)(async () => {
    if (loading) return;
    try {
      setLoading(true);
      setError(null);
...
function MicSelector({
  ...
  const [selectedDevice, setSelectedDevice] = (0, import_react3.useState)(value || "");
  const [internalMuted, setInternalMuted] = (0, import_react3.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(Chip, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        IconButton,
        {
          ...
          size: "sm",
          disabled: isError,
          children: isError ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_lucide_react5.MicOff, { className: `size-4` }) : isMuted ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_lucide_react5.MicOff, { className: `text-error size-4` }) : /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_lucide_react5.Mic, { className: `size-4` })
        }
      ),
      isError && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "bg-warning absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "text-hard-black text-xs leading-none font-bold", children: "!" }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "w-10", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
      LiveWaveform,
      {
        active: !isMuted,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(DropdownMenu, { onOpenChange: handleDropdownOpenChange, children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_lucide_react5.ChevronDown, { className: "size-6 flex-shrink-0" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(DropdownMenuContent, { align: "center", side: "top", className: "w-72", children: loading ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "text-muted-foreground px-4 py-3 text-center text-sm", children: "Loading devices..." }) : error ? /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "text-error px-4 py-3 text-center text-sm", children: [
        "Error: ",
        error
      ] }) : devices.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "text-muted-foreground px-4 py-3 text-center text-sm", children: "No microphones available" }) : /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_jsx_runtime14.Fragment, { children: devices.map((device) => /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
        DropdownMenuItem,
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "truncate", children: device.label }),
            selectedDevice === device.deviceId && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_lucide_react5.Check, { className: "size-5 flex-shrink-0" })
          ]
        },
        device.deviceId
      )) }) })
...
function Popover(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(PopoverPrimitive.Root, __spreadValues({ "data-slot": "popover" }, props));
}
function PopoverTrigger(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(PopoverPrimitive.Trigger, __spreadValues({ "data-slot": "popover-trigger" }, props));
}
...
var ValuePicker = React8.forwardRef(
  ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "flex flex-col gap-3", children: [
      label && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("label", { className: "text-small font-medium", children: label }),
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
              SelectPrimitive.Trigger,
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(SelectPrimitive.Value, { placeholder, asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "truncate leading-tight", children: (selectedItem == null ? void 0 : selectedItem.name) || placeholder }) }),
                  /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(SelectPrimitive.Icon, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(import_lucide_react6.ChevronDown, { className: "size-5" }) })
                ]
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(SelectPrimitive.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
              SelectPrimitive.Content,
              {
                ...
                sideOffset: 0,
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(SelectPrimitive.ScrollUpButton, { className: "flex cursor-default items-center justify-center py-1", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(import_lucide_react6.ChevronDown, { className: "size-4 rotate-180" }) }),
                  /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(SelectPrimitive.Viewport, { className: "max-h-[150px] overflow-y-auto", children: items.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "text-muted-foreground py-6 text-center text-sm", children: "No items found." }) : items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
                    SelectPrimitive.Item,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(SelectPrimitive.ItemText, { className: "flex-1", children: item.name }),
                        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "pointer-events-none absolute right-3 flex size-4 items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(SelectPrimitive.ItemIndicator, { children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(import_lucide_react6.Check, { className: "size-4" }) }) })
                      ]
                    },
                    item.id
                  )) }),
                  /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(SelectPrimitive.ScrollDownButton, { className: "flex cursor-default items-center justify-center py-1", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(import_lucide_react6.ChevronDown, { className: "size-4" }) })
                ]
              }
            ) })
          ]
...
var AudioVisualizer = ({
  ...
  const [isVisualizing, setIsVisualizing] = (0, import_react4.useState)(false);
  const audioContextRef = (0, import_react4.useRef)(null);
  const analyserRef = (0, import_react4.useRef)(null);
  const animationFrameRef = (0, import_react4.useRef)(void 0);
  const barsRef = (0, import_react4.useRef)([]);
  const animate = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: "relative z-10 flex h-[100px] items-center space-x-2", children: [...Array(9)].map((_, index) => /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
        "div",
        {
          ref: (el) => {
...
var import_agora_rtc_react = require("agora-rtc-react");
...
function MicButtonWithVisualizer({
  ...
  const [audioData, setAudioData] = (0, import_react5.useState)(
    Array(5).fill({ height: 0 })
  );
  const client = (0, import_agora_rtc_react.useRTCClient)();
  const audioContextRef = (0, import_react5.useRef)(null);
  const analyserRef = (0, import_react5.useRef)(null);
  const animationFrameRef = (0, import_react5.useRef)(void 0);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "absolute inset-0 flex items-center justify-center gap-1", children: audioData.map((bar, index) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
          "div",
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "relative z-10 transition-colors duration-300", children: isEnabled ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
          import_lucide_react7.Mic,
          {
            size: 24,
...
function ConvoTextStream({
  ...
  const [shouldAutoScroll, setShouldAutoScroll] = (0, import_react6.useState)(true);
  const [hasNewMessages, setHasNewMessages] = (0, import_react6.useState)(false);
  const scrollRef = (0, import_react6.useRef)(null);
  const lastMessageRef = (0, import_react6.useRef)(null);
  const prevMessageLengthRef = (0, import_react6.useRef)(messageList.length);
  const prevMessageTextRef = (0, import_react6.useRef)("");
  const hasSeenFirstMessageRef = (0, import_react6.useRef)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
    "div",
    {
      ...
      children: isOpen ? /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "flex shrink-0 items-center justify-end p-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("h3", { className: "mr-auto ml-2 font-semibold", children: "Transcription" }),
              /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                "button",
                {
                  onClick: toggleChat,
                  className: "inline-flex items-center justify-center rounded-md p-2 transition-colors hover:bg-white/10",
                  children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_lucide_react8.X, { className: "h-4 w-4" })
                }
              )
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
              "div",
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "space-y-4 p-4", children: allMessages.map((message, index) => /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
                  "div",
                  {
        ...
        "button",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_lucide_react8.MessageCircle, { className: "h-6 w-6 text-white transition-colors duration-300 ease-in-out group-hover:text-black group-active:text-black" })
        }
      )
    }
  );
